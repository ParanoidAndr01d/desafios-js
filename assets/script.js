...
// question objects
var dataTypeQ = {
  question: "Qual dos seguintes tipos de dados NÃO é um tipo de dados JavaScript?",
  answers: ["Boolean", "Null", "Empty", "String"],
  correctAnswer: "Empty",
};
var concatenateQ = {
  question: "Qual é uma maneira válida de concatenar uma string vazia? resultado = ''",
  answers: [
...
var preventQ = {
  question:
    "Qual função devemos chamar após um evento de envio para evitar a perda de dados?",
  answers: [
    "event.onLoad();",
...
var functionAsQ = {
  question: "JavaScript pode funcionar como QUE tipo de linguagem?",
  answers: [
    "Procedural",
    "Declarative",
    "Object Oriented",
...
var stringAndNumQ = {
  question:
    "Qual será a saída do console.log(x) para o console? var x = 5 + 4 + '1'",
  answers: ["'91'", "'541'", "10", "'10'"],
  correctAnswer: "'91'",
};
var randomNumQ = {
  question:
    "Qual expressão lhe daria apenas um número aleatório entre 0 e 9?",
  answers: [
...
var debugQ = {
  question:
    "Qual expressão é a ferramenta de depuração mais útil e menos intrusiva?",
  answers: ["alert(x);", "confirm(x);", "prompt(x);", "console.log(x);"],
  correctAnswer: "console.log(x);",
};
var booleanDataQ = {
  question: "Que tipo de dados var x representa? x = true",
